...
Il convient de noter que la version de @samSim a été intégrée dans le [samSim package](https://github.com/Pacific-salmon-assess/samSim) et que nous utilisons l’étiquette *samSim* pour cette option dans les fonctions de *RapidRicker*.
